...
const Home = ({ navigation, language }) => {
  ...
  useEffect(() => {
    const top5Recipes = recipes.slice(0, 5);
    setRecipeList(top5Recipes);
  }, []);

  useEffect(() => {}, [randomIndex]);
  ...
  const menuLabels = {
    ...
    fr: {
      ...
      randomTextDescription:
        "Secouez votre téléphone pour obtenir une recette aléatoire",
    },
  };
